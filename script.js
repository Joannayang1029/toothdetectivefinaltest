...
function showCurrentPage() {
    ...
    if (currentPage === 1 || currentPage === 2 || currentPage === 3) {
        ...
        tableContainer.style.top = "28%"; //越大越往下
        tableContainer.style.left = "53%";
        ...
        questions.forEach((q, index) => {
            ...
            html += `
                <tr style="height: ${rowHeight};">
                    <!-- 題號（位置固定） -->
                    <td style=" padding: 16px 8px; width: 5%; text-align:center; font-weight:900; vertical-align:middle; color:${rowColor};">
                        ${index+1}
                    </td>
                    <!-- 題目（右移 + 加寬） -->
                    <td style=" padding: 16px 25px; width: 48%; text-align:left; vertical-align:middle; color:${rowColor};">
                        ${q.question}
                    </td>
                    <!-- 答案（右移 + 加寬） -->
                    <td style="padding: 16px 25px; width: 35%; text-align:left; font-weight:900; vertical-align:middle; color:${rowColor};">
                        ${userAnswerText}
                    </td>
                </tr>
            `;
